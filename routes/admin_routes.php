...
Route::group(['prefix' => 'admin', 'namespace' => 'Admin', 'middleware' => ['auth', 'adminAuth']], function () use ($router) {
    ...
    $router->group(["prefix" => "application"], function () use ($router) {
        ...
        $router->post("ajax_list", "ApplicationController@ajax_list");
        $router->post("addnewajax", "ApplicationController@addnewajax");
        $router->post("get_content", "ApplicationController@get_content");
        $router->post('update_status', 'ApplicationController@update_status');
        $router->get('view/{id}', 'ApplicationController@details');
        //call
        // $router->post("get_content", "HighlightController@get_content");
        $router->post("addnewajaxCall", "ApplicationController@addnewajaxCall");
        $router->post("delete", "ApplicationController@deleteSelected");
    });
