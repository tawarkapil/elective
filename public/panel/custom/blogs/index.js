$(function(){
    ...
    function draw_data() {
        ...
        ajaxTbl = $('#custom-ajax-tbl').DataTable({
            ...
            responsive: true, 
            ajax: {
                url: ADMIN_HTTP_PATH + "blogs/ajax_list",
                type: "POST",
                data: {
            ...
            columns: [
                ...
                { data: 'author_name', "orderable": true},
                { data: 'cust_trips.title', "orderable": true},
    ...
    function getfillform(_this){
        $.ajax({
            type: "POST",
            url: ADMIN_HTTP_PATH + 'blogs/get_content',
    ...
    $("body").on('submit', '#submitFrm', function (e) {
        ...
        $.ajax({
         type: "POST",
         url: ADMIN_HTTP_PATH + 'blogs/addnewajax',
         data: dataS,
         contentType: false,
         cache: false,
         processData:false,
    ...
    $('body').on('click', '.delConfirmationBtn', function(e){
        ...
        $.ajax({
         type: "POST",
         url: ADMIN_HTTP_PATH + 'blogs/delete',
         data: 'id=' + id + "&_token=" + CSRF_TOKEN,
         dataType: 'json',
         success: function(data){
            error_remove();
    ...
    $("body").on("click", ".confirm_status", function (e) {
         ...
         $.ajax({
             type: "POST",
                 url: ADMIN_HTTP_PATH + "blogs/update_status",
