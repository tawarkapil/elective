$(function(){
	...
	$("body").on("click", '.addNewBtn', function (e) {
        ...
        $('#submitFrmMdl').find('#page_headline').text('Add call');
    ...
    $("body").on("click", ".editBtn", function (e) {
        ...
        $('#submitFrmMdl').find("#page_headline").html('Edit call');
        getfillform(_this);
    });
