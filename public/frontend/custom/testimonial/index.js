$(function(){
    ...
    function draw_data() {
        ...
        ajaxTbl = $('#custom-ajax-tbl').DataTable({
            ...
            responsive: true, 
            ajax: {
                url: HTTP_PATH + "my-testimonials/ajax_list",
                type: "POST",
                data: {
    ...
    function getfillform(_this){
        $.ajax({
            type: "POST",
            url: HTTP_PATH + 'my-testimonials/get_content',
    ...
    $("body").on('submit', '#submitFrm', function (e) {
        ...
        $.ajax({
         type: "POST",
         url: HTTP_PATH + 'my-testimonials/addnewajax',
         data: dataS,
         contentType: false,
         cache: false,
         processData:false,
    ...
    $('body').on('click', '.delConfirmationBtn', function(e){
        ...
        $.ajax({
         type: "POST",
         url: HTTP_PATH + 'my-testimonials/delete',
         data: 'id=' + id + "&_token=" + CSRF_TOKEN,
         dataType: 'json',
         success: function(data){
            error_remove();
    ...
    $("body").on("click", ".confirm_status", function (e) {
         ...
         $.ajax({
             type: "POST",
                 url: HTTP_PATH + "my-testimonials/update_status",
