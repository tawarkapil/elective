         ...
         <div class="row mb-2">
            ...
            <div class="col-sm-6">
               <ol class="breadcrumb float-sm-right">
                  ...
                  <li class="breadcrumb-item"><a class="text-muted" href="{{ url('admin/programs') }}">Programs</a></li>
            ...
            <div class="col-12">
               <div class="card">
                  <div class="card-header">
                     <h3 class="card-title float-left">Program View</h3>
                  </div>
                  <div class="card-body ribbon-box pb-1">
                     <div class="row">
                        <div class="col-md-2">
                           <label class="control-label">Image</label>
                           <div style="border: 1px solid #DDD;padding: 3px;background-size: cover;"><img src="{{ url('public/uploads/programs/'.$data->image) }}" width="100%"></div>
                        </div>
                     </div>
                     <div class="row">
                        <div class="col-md-4">
                        ...
                        <div class="col-md-4">
                           <div class="form-group">
                              ...
                              <?php 
                              $catArr = [1 => 'Healthcare', 2 => 'Business', 3 => 'Camps'];
                              ?>
                              <p>{{ $catArr[$data->category] }}</p>
                           </div>
                        </div>
                        <div class="col-md-4">
                           <div class="form-group">
