               ...
               <div class="row">
                  ...
                  <div class="col-lg-6">
                     <div class="form-group">
                        ...
                        {!! Form::select('category', [ '' => 'Please Select', 1 => 'Healthcare', 2 => 'Business', 3 => 'Camps'], null, ['id' => 'category', 'class' => 'form-control']) !!}
                     </div>
                  </div>
                  <div class="col-lg-6">
                     <div class="form-group">
...
<script type="text/javascript" src="{{ url('public/panel/custom/program/index.js') }}"></script>
@endsection