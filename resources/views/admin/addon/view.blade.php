...
<div class="content-wrapper">
   ...
   <div class="content-header">
      <div class="container-fluid">
         <div class="row mb-2">
            <div class="col-sm-6">
               <h1 class="m-0">Add-Ons & Events View</h1>
            </div>
            <!-- /.col -->
            <div class="col-sm-6">
               <ol class="breadcrumb float-sm-right">
                  <li class="breadcrumb-item"><a class="text-muted" href="{{ url('admin/dashboard') }}">Home</a></li>
                  <li class="breadcrumb-item"><a class="text-muted" href="{{ url('admin/addons') }}">Add-Ons & Events</a></li>
                  <li class="breadcrumb-item active">Add-Ons & Events View</li>
               </ol>
            </div>
            <!-- /.col -->
         </div>
            ...
            <div class="col-12">
               <div class="card">
                  <div class="card-header">
                     <h3 class="card-title float-left">Add-Ons & Events View</h3>
                  </div>
                  <div class="card-body ribbon-box pb-1">
                     <div class="row">
                        <div class="col-md-2">
                           <label class="control-label">Image</label>
                           <div style="border: 1px solid #DDD;padding: 3px;background-size: cover;"><img src="{{ url('public/uploads/addons/'.$data->image) }}" width="100%"></div>
                        </div>
                     </div>
                     <div class="row">
                        <div class="col-md-4">
                           ...
                           <table class="table table-bordered">
                              ...
                              <tbody>
                                 ...
                                 <tr>
                                    <td>{{ $key + 1 }}</td>
                                    <td>
                                       <img src="{{ url($val->attachment) }}" style="border: 1px solid #DDD;padding: 3px;height: 100px;width: 100px;">
                                    </td>
                                    <td>{!! $val->description !!}</td>
                                    <td>
                                       <div class="text-nowrap text-center table-action">
                                          <a title="Edit" class="editBtn action-icon text-muted" data-key="{{ base64_encode($val->id) }}" href="#" > <i class="fa fa-edit" aria-hidden="true"></i> </a>
                                          <a title="Delete" class="deleteBtn action-icon text-muted" data-key="{{ base64_encode($val->id) }}" href="#" > <i class="fa fa-trash" aria-hidden="true"></i> </a>
                                       </div>
                                    </td>
                                 </tr>
                                 @endforeach
