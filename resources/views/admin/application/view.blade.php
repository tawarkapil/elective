    ...
    <div class="content-wrapper">
        ...
        <div class="content-header">
            <div class="container-fluid">
                <div class="row mb-2">
                    <div class="col-sm-6">
                        <h1 class="m-0">Application View</h1>
                    </div>
                    <!-- /.col -->
                    <div class="col-sm-6">
                        <ol class="breadcrumb float-sm-right">
                            ...
                            <li class="breadcrumb-item"><a class="text-muted" href="{{ url('admin/application') }}">Application</a></li>
                    ...
                    <div class="col-12">
                        <div class="card">
                            <div class="card-header">
                                <h3 class="card-title float-left">Application View</h3>
                            </div>
                                ...
                                {{-- <div class="row">
                                    <div class="col-md-2">
                                        ...
                                        <div style="border: 1px solid #DDD;padding: 3px;background-size: cover;"><img
                                                src="{{ url('public/uploads/tours/' . $data->image) }}" width="100%"></div>
                                    </div>
                                </div> --}}
                                <div class="row">
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            <label class="control-label">Name {{ $data->id }}</label>
                        ...
                        <div class="card">
                            <div class="card-header">
                                <h4 class="card-title float-left">Calls</h4>
                ...
                <form name="submitFrm" id="submitFrm">
                    ...
                    <div class="modal-body">
                        <div class="row">
                            <div class="col-lg-12">
                                <div class="form-group">
                                    <label for="image">Title <span class="required text-danger">*</span></label><br />
...
@section('scripts')
    <script type="text/javascript">
        var type = "Tour";
        var application = "{{ $data->id }}";
    </script>
    <script src="https://cdn.ckeditor.com/4.11.1/full-all/ckeditor.js"></script>
    <script type="text/javascript" src="{{ url('public/panel/custom/application/calls.js') }}"></script>
@stop
