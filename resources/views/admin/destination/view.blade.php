         ...
         <div class="row mb-2">
            ...
            <div class="col-sm-6">
               <ol class="breadcrumb float-sm-right">
                  ...
                  <li class="breadcrumb-item"><a class="text-muted" href="{{ url('admin/destinations') }}">Destinations</a></li>
                  ...
                  <div class="card-body ribbon-box pb-1">
                     <div class="row">
                        <div class="col-md-2">
                           ...
                           <div style="border: 1px solid #DDD;padding: 3px;background-size: cover;"><img src="{{ url('public/uploads/destinations/'.$data->image) }}" width="100%"></div>
                        </div>
                     </div>
                     <div class="row">
                        <div class="col-md-4">
