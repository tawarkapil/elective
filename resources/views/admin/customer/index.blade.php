            ...
            <div class="card">
              <div class="card-header">
                ...
                <div class="float-right">
                    <!-- <a href="{{ url('admin/customers/addnew') }}" class="btn bg-gradient-primary "><i class="fa fa-plus"></i> Add New</a> -->
...
<script type="text/javascript" src="{{ url('public/panel/custom/customer/index.js') }}"></script>
@endsection