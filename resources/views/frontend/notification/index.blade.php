...
@section('title')
<title>Notifications - {{ ViewsHelper::getConfigKeyData('website_title') }}</title>
@stop
@section('content')
...
<script type="text/javascript" src="{{ url('public/frontend/custom/notification/index.js') }}"></script>
@endsection