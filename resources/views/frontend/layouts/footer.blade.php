 <!-- Footer -->
<footer id="footer" class="footer pb-0" data-bg-img="{{ url('public/frontend/assets/images/footer-bg.png') }}" data-bg-color="#25272e">
 <div class="container pb-20">
    <div class="row multi-row-clearfix">
      <div class="col-sm-6 col-md-6">
          <div class="widget dark">  <a href="{{ url('/') }}" class="logo_title">Electives <span class="text-theme-colored">Global</span></a><!--  <img alt="" src="images/logo-wide-white.png"> -->
 ...
 <div class="container-fluid bg-theme-colored p-20">
    <div class="row text-center">
       <div class="col-md-12">
          <p class="text-white font-11 m-0">Copyright &copy; {{ date('Y') }} Elective Global. All Rights Reserved</p>
       </div>
    </div>
 </div>
</footer>
