                        ...
                        <div class="card">
                            <div class="card-header">
                                ...
                                <div class="float-right">
                                    <button type="button" class="btn btn-primary addNewBtn"><i class="fa fa-plus"></i> Add
                                        New</button>
...
@section('scripts')
    ...
    <script type="text/javascript" src="{{ url('public/frontend/custom/blogs/index.js') }}"></script>
@endsection
