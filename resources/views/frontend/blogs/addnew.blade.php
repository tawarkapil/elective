...
@include('frontend.layouts.sidebar')
                     ...
                     <div class="row">
                        ...
                        <div class="col-lg-6">
                           ...
                           <div class="form-group">
                              ...
                              {!! Form::select('category_id', ['' => 'Please Select'] + $categories, ($data) ? $data->category_id : null, ['id' => 'category_id', 'class' => 'form-control']) !!}
                        ...
                        <div class="col-lg-6">
                           ...
                           <div class="form-group">
                              ...
                              <select name="tags[]" id="tags" class="form-control" multiple="true">
                                 ...
                                 <option @if($data && in_array($val, explode(',', $data->tags))) selected="selected" @endif value="{{ $val }}">{{ $val }}</option>
 ...
 -->
                           ...
                           <div class="form-group">
                              ...
                              <div class="d-flex">
                                 ...
                                 <div class="icheck-primary d-inline mr-2">
                                   ...
                                   <input type="radio" id="upload_file_image" name="upload_file"  value="Image" @if(!$data || ($data && $data->upload_file == 'Image')) checked="" @endif>
                                 ...
                                 <div class="icheck-primary d-inline">
                                   ...
                                   <input type="radio" id="image_type_video" name="upload_file" value="Video" @if($data && $data->upload_file == 'Video') checked="" @endif >
                     ...
                     <div class="row youtube_url_bx" @if($data && $data->upload_file == 'Video')  @else style="display:none;" @endif>
                        ...
                        <div class="col-lg-12">
                           ...
                           <div class="form-group">
                              ...
                              <textarea name="youtube_url" id="youtube_url" class="form-control" rows="3" placeholder="Please enter embeded code">{{ ($data) ? $data->youtube_url : '' }}</textarea>
                    ...
                    <div class="row image_upload_bx" @if(!$data || ($data && $data->upload_file == 'Image')) @else  style="display:none;" @endif>
                                        ...
                                        @foreach($data->attachments as $file)
                                          ...
                                          <div class="gallery-item documentfileContainer" data-key="{{ $file->attachment }}" >
                                            ...
                                            <div class="thumb">
                                              ...
                                              <img class="img-fullwidth" src="{{ ViewsHelper::getBlogImage($file)  }}" alt="project">
