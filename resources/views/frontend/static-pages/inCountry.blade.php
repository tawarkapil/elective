   ...
   <div class="content-header">
      <div class="container-fluid">
         <div class="row mb-2">
            <div class="col-sm-6">
               <h1 class="m-0"> 
                  @if($page == 'orientation-logbook')
                  Orientation Logbook
                  @elseif($page == 'accommodation')
                  Accommodation
                  @elseif($page == 'hospital-center')
                  Hospital/Center
                  @elseif($page == 'departure')
                  Departure
                  @endif
               </h1>
            </div>
            ...
            <div class="col-12">
               <div class="card">
                  ...
                  <div class="card-body">
                     ...
                     <h5>For you:</h5>
                     @foreach($system_documents as $row)
                     <div>{{ $row->document_name }} (<a target="_blank" href="{{ url($row->document_path) }}">Download</a>)</div>
                     @endforeach
                     @endif
                     @if(count($student_documents) > 0)
                     <h5>For us:</h5>
