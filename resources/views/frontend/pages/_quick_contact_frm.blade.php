<section id="inquiry-tab" class="divider grey_bg" data-bg-img="{{ url('public/frontend/assets/images/enquire-form-grey.jpg') }}">
     ...
     <div class="row text-center">
      <div class="col-sm-4">
        <div class="icon-box iconbox-theme-colored blue_bg_color p-30">
          <a class="icon icon-dark icon-bordered icon-rounded icon-border-effect effect-rounded" href="{{ url('programs') }}">
          ...
          <a class="btn btn-flat btn-dark mt-15 quick-link-btn-hover" href="{{ url('programs') }}">Read more</a>
        </div>
      </div>
      <div class="col-sm-4">
        <div class="icon-box iconbox-theme-colored blue_bg_color p-30">
          <a class="icon icon-dark icon-bordered icon-rounded icon-border-effect effect-rounded" href="{{ url('trips') }}">
            <i class="fa fa-group text-white"></i>
          </a>
          <h5 class="icon-box-title text-yellow">Group trips</h5>
          <p class="text-white">Lorem ipsum dolor sit amet, consectetur adipisicing elit. Molestias non nulla placeat, odio, qui dicta alias.</p>
          <a class="btn btn-flat btn-dark mt-15 quick-link-btn-hover" href="{{ url('trips') }}">Read more</a>
        </div>
      </div>
      <div class="col-sm-4">
        <div class="icon-box iconbox-theme-colored blue_bg_color p-30">
          <a class="icon icon-dark icon-bordered icon-rounded icon-border-effect effect-rounded" href="{{ url('destinations') }}">
            <i class="fa fa-map text-white"></i>
          </a>
          <h5 class="icon-box-title text-yellow">Destinations</h5>
          <p class="text-white">Lorem ipsum dolor sit amet, consectetur adipisicing elit. Molestias non nulla placeat, odio, qui dicta alias.</p>
          <a class="btn btn-flat btn-dark mt-15 quick-link-btn-hover" href="{{ url('destinations') }}">Read more</a>
        </div>
      </div>
    </div>
    </div>
