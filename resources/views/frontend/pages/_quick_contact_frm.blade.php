            ...
            <div class="col-md-7">
                <div class="blue_bg_color p-40">
                            ...
                            <div class="col-sm-6">
                                <div class="form-group">
                                    <label for="institution">Institution <span
                                            class="required text-white">*</span></label>
                                    <input name="institution" id="institution" class="form-control" type="text"
                                        placeholder="Institution">
                                </div>
                            </div>
                            <div class="col-sm-12">
                                <div class="form-group"> <label for="subject">Subject <span
                                            class="required text-white">*</span></label> <input name="subject"
                                        id="subject" class="form-control" type="text" placeholder="Enter Subject">
                                </div>
                            </div>
                  ...
                  <div class="form-group">
                    ...
                    {!! Form::select('program', ['' => 'Please Select'] + ViewsHelper::getProgramsList(), null, [
                        'id' => 'program',
                        'class' => 'form-control',
                    ]) !!}
                  </div>
                            ...
                            <div class="col-sm-12">
                                <div class="form-group mb-20">
                                    <button type="submit"
                                        ...
                                        data-loading-text="Please wait...">Contact Us</button>
                                </div>
                            </div>
                        </div>
                    </form>
            ...
            <div class="row text-center">
                <div class="col-sm-4">
                    <div class="icon-box iconbox-theme-colored blue_bg_color p-30">
                        <a class="icon icon-dark icon-bordered icon-rounded icon-border-effect effect-rounded"
                            href="{{ url('programs') }}">
                            <i class="fa fa-tasks text-white"></i>
                        </a>
                        <h4 class="icon-box-title text-yellow">Programs</h4>
                        <p class="text-white">Lorem ipsum dolor sit amet, consectetur adipisicing elit. Molestias non
                            nulla placeat, odio, qui dicta alias.</p>
                        <a class="btn btn-flat btn-dark mt-15 quick-link-btn-hover" href="{{ url('programs') }}">Read
                            more</a>
                    </div>
                </div>
                <div class="col-sm-4">
                    <div class="icon-box iconbox-theme-colored blue_bg_color p-30">
                        ...
                        <p class="text-white">Lorem ipsum dolor sit amet, consectetur adipisicing elit. Molestias non
                            nulla placeat, odio, qui dicta alias.</p>
                        <a class="btn btn-flat btn-dark mt-15 quick-link-btn-hover" href="{{ url('trips') }}">Read
                            more</a>
                    </div>
                </div>
                <div class="col-sm-4">
                    <div class="icon-box iconbox-theme-colored blue_bg_color p-30">
                        ...
                        <p class="text-white">Lorem ipsum dolor sit amet, consectetur adipisicing elit. Molestias non
                            nulla placeat, odio, qui dicta alias.</p>
                        <a class="btn btn-flat btn-dark mt-15 quick-link-btn-hover"
                            href="{{ url('destinations') }}">Read more</a>
                    </div>
                </div>
            </div>
        </div>
