      ...
      <div class="container">
        <div class="section-content">
          <div class="row">
            <div class="col-md-4">
              <div class="thumb">
                <img style="height: 270px;object-fit: cover;" src="{{ ViewsHelper::getTripCoverImage($data) }}" alt="">
              </div>
            </div>
            <div class="col-md-8">
              <div class="">
              ...
              <h6 class="mt-5">Organiser : {{ ($data->getcustomer) ? $data->getcustomer->full_name() : 'N/A' }}</h6>
                ...
                <div class="row">
                  <div class="col-sm-12">
                    <div class="form-group">
                      <input type="text" placeholder="Enter Name" id="contact_name" name="contact_name" value="{{ (Auth::guard('customer')->check()) ? Auth::guard('customer')->user()->full_name() : '' }}" readonly="" class="form-control">
                    </div>
                  </div>
                  <div class="col-sm-12">
                    <div class="form-group">
              ...
              <div class="item">
                <article class="post clearfix maxwidth600 mb-sm-30">
                  ...
                  <div class="entry-content border-1px p-20">
                    ...
                    <p class="text-left mb-20 mt-15 font-13 text-justify">{{ $row->short_desc(150) }}</p>
