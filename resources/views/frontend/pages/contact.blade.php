              ...
              <div class="row">
                ...
                <div class="col-sm-6">
                  <div class="form-group">
                    ...
                    {!! Form::select('program', ['' => 'Please Select'] + $programs, null, ['id' => 'program', 'class' => 'form-control']) !!}
                  </div>
                </div>
...
@stop
@section('scripts')
<script type="text/javascript" src="{{ url('public/frontend/custom/pages/contact.js') }}"></script>
@stop
@section('styles')
@stop
