...
@section('title')
<title>About Us - {{ ViewsHelper::getConfigKeyData('website_title') }}</title>
@stop
@section('content')  
<!-- Start main-content -->
        ...
        <div class="row">
          <div class="col-sm-12 col-md-7">
            <div class="image-carousel">
              <div class="item">
                <div class="thumb">
                  <img src="{{ url('public/frontend/assets/images/about-1.jpg') }}" alt="">
                </div>
              </div>
              <div class="item">
                <div class="thumb">
                  <img src="{{ url('public/frontend/assets/images/about-2.jpg') }}" alt="">
                </div>
              </div>
              <div class="item">
                <div class="thumb">
                  <img src="{{ url('public/frontend/assets/images/about-3.jpg') }}" alt="">
                </div>
              </div>
            </div>
          </div>
