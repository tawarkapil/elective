                                                ...
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-sm-8">
                                                        <input type="text" class="form-control" id="dob"
                                                            ...
                                                            value="<?php echo e($data->dob ? date('d-m-Y', strtotime($data->dob)) : ''); ?>">
                                                    </div>
                                                </div>
                                                <div class="form-group row">
                                                ...
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-sm-8">
                                                        <input type="text" class="form-control" id="phone_number"
                                                            name="phone_number" value="<?php echo e($data->phone_number); ?>"
                                                ...
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-sm-8">
                                                        <input type="text" class="form-control" id="address1"
                                                            name="address1" value="<?php echo e($data->address1); ?>"
                                                ...
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-sm-8">
                                                        <input type="text" class="form-control" id="address2"
                                                            name="address2" value="<?php echo e($data->address2); ?>"
                                                ...
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-sm-8">
                                                        <input type="text" class="form-control" id="city"
                                                            name="city" value="<?php echo e($data->city); ?>"
                                                            placeholder="Address line 2">
                                                    </div>
                                                </div>
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-sm-8">
                                                        <?php echo Form::select('country', ['' => 'Select Country'] + $countries, $data ? $data->country : $default_country, [
                                                            'id' => 'country',
                                                            'class' => 'form-control',
                                                        ]); ?>
                                                ...
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-sm-8">
                                                        <input type="text" class="form-control" id="zip_code"
                                                            name="zip_code" value="<?php echo e($data->zip_code); ?>"
                                                ...
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-sm-8">
                                                        <input type="text" class="form-control" id="university"
                                                            ...
                                                            value="<?php echo e($data->university); ?>">
                                                    </div>
                                                </div>
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-sm-8">
                                                        <input type="text" class="form-control" id="degree_title"
                                                            ...
                                                            value="<?php echo e($data->degree_title); ?>">
                                                    </div>
                                                </div>
                                                <div class="form-group row">
                                                ...
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-sm-8">
                                                        <input type="text" class="form-control" id="graduation_date"
                                                            name="graduation_date" value="<?php echo e($data->graduation_date); ?>"
                                                            placeholder="Eg. 2001">
                                                    </div>
                                                </div>
                                            </div>
                                            ...
                                            <div class="card-body">
                                                <div class="form-group row">
                                                    <label class="col-sm-6 col-form-label">Which program would you like to
                                                        enroll in?</label>
                                                    <div class="col-sm-6">
                                                        <?php echo Form::select('program', $programs, $data ? $data->program : null, [
                                                            'id' => 'program',
                                                ...
                                                <div class="form-group row">
                                                    <label class="col-sm-6 col-form-label">Where would you like to
                                                        go?</label>
                                                    <div class="col-sm-6">
                                                        <?php echo Form::select('destination', $destinations, $data ? $data->destination : null, [
                                                            'id' => 'destination',
                                                            'class' => 'form-control  changeSummaryVal',
                                                        ]); ?>
                                                ...
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-sm-6">
                                                        <input type="text" name="trip_start_date" id="trip_start_date"
                                                            class="form-control"
                                                            value="<?php echo e($data->trip_start_date ? date('d-m-Y', strtotime($data->trip_start_date)) : ''); ?>">
                                                    </div>
                                                </div>
                                                <div class="form-group row">
                                                ...
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-sm-6">
                                                        ...
                                                        <input type="text" name="preferences_allergies"
                                                            ...
                                                            value="<?php echo e($data ? $data->preferences_allergies : ''); ?>">
                                                    </div>
                                                </div>
                                                ...
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-sm-6">
                                                        ...
                                                        <input type="text" name="other_preferences"
                                                            ...
                                                            value="<?php echo e($data ? $data->other_preferences : ''); ?>">
                                                    </div>
                                                </div>
                                            </div>
                                            <!-- /.card-body -->
                                ...
                                <div class="tab-pane fade active show">
                                    <div class="row">
                                        <?php $__currentLoopData = $tours; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $row): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <div class="col-sm-6">
                                                <div class="card">
                                                    <img src="<?php echo e(url('public/uploads/tours/' . $row->image)); ?>"
                                                        class="card-img-top" alt="...">
                                                    <div class="card-body">
                                                        <h4> 
                                                            <a href="<?php echo e($row->getDetailsPageUrl()); ?>">
...
<?php $__env->startSection('styles'); ?>
    <link rel="stylesheet" type="text/css"
        href="<?php echo e(url('public/frontend/assets/plugins/daterangepicker/daterangepicker.css')); ?>" />
    <style>
...
<?php echo $__env->make('frontend.layouts.dashboard_app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/html/elective/resources/views/frontend/profile/application.blade.php ENDPATH**/ ?>