            ...
            <article class="post clearfix maxwidth600 mb-30">
                ...
                <div class="entry-content border-1px p-20">
                    <h5 class="entry-title mt-0 pt-0">
                        <a href="<?php echo e($row->getDetailsPageUrl()); ?>"><?php echo e($row->short_title(40)); ?></a>
                    </h5>
                    ...
                    <ul class="list-inline entry-date pull-right font-12 mt-5">
                        <li><a class="text-theme-colored-blue" href="#"><?php echo e($row->getcustomer->full_name()); ?> |</a>
                        </li>
                        <li><span
                                class="text-theme-colored-blue"><?php echo e(ViewsHelper::displayDate($row->created_at)); ?></span>
                        </li>
                    </ul>
...
<?php /**PATH /var/www/html/elective/resources/views/frontend/pages/_ajax_trip.blade.php ENDPATH**/ ?>