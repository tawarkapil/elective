            ...
            <div class="col-md-12">
               <div class="card">
                  <div class="card-header">
                     <h3 class="card-title float-left">Programs</h3>
         ...
         <form name="submitFrm" id="submitFrm">
            ...
            <div class="modal-body">
               ...
               <div class="row">
                  ...
                  <div class="col-lg-6">
                     <div class="form-group">
                        ...
                        <?php echo Form::select('category', [ '' => 'Please Select', 1 => 'Healthcare', 2 => 'Business', 3 => 'Camps'], null, ['id' => 'category', 'class' => 'form-control']); ?>
               ...
               <div class="row">
                  ...
                  <div class="col-lg-12">
                     <div class="form-group">
                        <label for="common_condition">Common Conditions <span class="required text-danger">*</span></label>
                        <textarea class="form-control" rows="5" id="common_condition" name="common_condition"></textarea>
                     </div>
                  </div>
                  <div class="col-lg-12">
                     <div class="form-group">
                        <label for="program_focus_point">Program Focus Points <span class="required text-danger">*</span></label>
                        <textarea class="form-control" rows="5" id="program_focus_point" name="program_focus_point"></textarea>
                     </div>
                  </div>
               </div>
            </div>
...
<script type="text/javascript" src="<?php echo e(url('public/panel/custom/program/index.js')); ?>"></script>
<?php $__env->stopSection(); ?>
<?php echo $__env->make('admin.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home1/digital5/public_html/elective/resources/views/admin/program/index.blade.php ENDPATH**/ ?>