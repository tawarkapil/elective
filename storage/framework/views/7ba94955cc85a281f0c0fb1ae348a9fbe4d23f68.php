         ...
         <div class="row mb-2">
            ...
            <div class="col-sm-6">
               <ol class="breadcrumb float-sm-right">
                  ...
                  <li class="breadcrumb-item"><a class="text-muted" href="<?php echo e(url('admin/programs')); ?>">Programs</a></li>
                  ...
                  <div class="card-body ribbon-box pb-1">
                     <div class="row">
                        <div class="col-md-2">
                           ...
                           <div style="border: 1px solid #DDD;padding: 3px;background-size: cover;"><img src="<?php echo e(url('public/uploads/programs/'.$data->image)); ?>" width="100%"></div>
                        </div>
                     </div>
                     <div class="row">
                        <div class="col-md-4">
                        ...
                        <div class="col-md-4">
                           <div class="form-group">
                              ...
                              ?>
                              <p><?php echo e($catArr[$data->category]); ?></p>
                           </div>
                        </div>
                        <div class="col-md-4">
                           <div class="form-group">
                        ...
                        <div class="col-md-12">
                           <div class="form-group">
                              ...
                              <div id="accordion">
                                 ...
                                 <?php endif; ?>
                                 <?php if($data->program_focus_point): ?>
                                 <div class="card card-secondary">
                                    <div class="card-header">
                                       <h4 class="card-title w-100">
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('admin.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home1/digital5/public_html/elective/resources/views/admin/program/view.blade.php ENDPATH**/ ?>