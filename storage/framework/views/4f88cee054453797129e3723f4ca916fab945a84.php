         ...
         <div class="col-md-3">
            ...
            <div class="card card-warning card-outline">
               <div class="card-body box-profile">
                  <div class="text-center" style="position:relative;">
                     <img class="profile-user-img img-fluid img-circle update-pic-cls" src="<?php echo e(ViewsHelper::displayUserProfileImage($data)); ?>" style="height:120px;width: 120px;" alt="User profile picture">
                  ...
                  <h3 class="profile-username text-center"><?php echo e($data->full_name()); ?></h3>
                  <p class="text-muted text-center"><?php echo e($data->email); ?></p>
                  <ul class="list-group list-group-unbordered mb-3">
                     <li class="list-group-item">
                        <b>Date of birth</b> <a class="float-right"><?php echo e(($data->dob) ? ViewsHelper::displayDate($data->dob) : 'N/A'); ?></a>
                     </li>
                     <li class="list-group-item">
                        <?php
                        $genderArr = [1 => 'Male', 2 => 'Female', 3 => 'Unspecified', 4 => 'Undisclosed']; 
                        ?>
                        <b>Gender</b> <a class="float-right"> <?php echo e(isset($genderArr[$data->gender]) ? $genderArr[$data->gender] : 'N/A'); ?></a>
                     </li>
                  </ul>
               </div>
               <!-- /.card-body -->
            ...
            <div class="card card-warning card-outline">
               ...
               <div class="card-body">
                  ...
                  <p class="text-muted">
                     <?php echo e($data->degree_title); ?> from the <?php echo e($data->university); ?>

                  </p>
                  <hr>
                  <strong><i class="fas fa-map-marker-alt mr-1"></i> Location</strong>
                  <p class="text-muted"><?php echo e($data->city); ?>, <?php echo e($data->getcountry->name); ?> - <?php echo e($data->zip_code); ?></p>
               </div>
               <!-- /.card-body -->
            </div>
            <!-- /.card -->
               ...
               <div class="card-body">
                  <form name="personalInfoFrm" id="personalInfoFrm">
                     ...
                     <div class="form-group row">
                        ...
                        <div class="col-sm-9">
                           <textarea class="form-control" id="about_me" name="about_me" placeholder="About me"><?php echo e($data->about_me); ?></textarea>
                        </div>
                     </div>
                     <div class="form-group row">
                        <div class="col-sm-12">
               ...
               <div class="card-body" style="display: none;">
                  <form id="socialFrm" name="socialFrm">
                     <div class="form-group row">
                        ...
                        <div class="col-sm-9">
                           <input type="text" class="form-control" id="facebook_url" name="facebook_url" placeholder="Facebook URL" value="<?php echo e($data->facebook_url); ?>">
                        </div>
                     </div>
                     <div class="form-group row">
                        ...
                        <div class="col-sm-9">
                           <input type="text" class="form-control" id="instagram_url" name="instagram_url" placeholder="Instagram URL" value="<?php echo e($data->instagram_url); ?>">
                        </div>
                     </div>
                     <div class="form-group row">
                        ...
                        <div class="col-sm-9">
                           <input type="text" class="form-control" id="twitter_url" name="twitter_url" placeholder="X (Twitter) URL" value="<?php echo e($data->twitter_url); ?>">
                        </div>
                     </div>
                     <div class="form-group row">
                        ...
                        <div class="col-sm-9">
                           <input type="text" class="form-control" id="google_url" name="google_url" value="<?php echo e($data->google_url); ?>" placeholder="Google+ URL">
                        </div>
                     </div>
                     <div class="form-group row">
                        <div class="col-sm-12">
                                 ...
                                 <div class="row displayUploadedFileName">
                                    <?php if(isset($data->attachments) && count($data->attachments) > 0 ): ?>
                                        <?php $__currentLoopData = $data->attachments; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $file): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                          ...
                                          <div class="col-sm-2">
                                            <a href="<?php echo e(ViewsHelper::getBlogImage($file)); ?>" data-toggle="lightbox" data-gallery="gallery">
                                              <img src="<?php echo e(ViewsHelper::getBlogImage($file)); ?>" class="im
...
<link rel="stylesheet" type="text/css" href="<?php echo e(url('public/frontend/dashboard/plugins/ekko-lightbox/ekko-lightbox.css')); ?>" />
<style type="text/css">
   .files input {
...
<script src="<?php echo e(url('public/frontend/dashboard/plugins/ekko-lightbox/ekko-lightbox.min.js')); ?>"></script>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('frontend.layouts.dashboard_app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\xampp82\htdocs\elective\resources\views/frontend/profile/index.blade.php ENDPATH**/ ?>