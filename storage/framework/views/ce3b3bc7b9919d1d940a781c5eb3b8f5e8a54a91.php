          ...
          <div class="col-md-12">
            <div class="card">
              <div class="card-header">
                <h3 class="card-title float-left">Testimonials</h3>
      ...
      <div class="modal-content">
         <form name="submitFrm" id="submitFrm">
            ...
            <div class="modal-body">
               ...
               <div class="col-lg-12">
                  <div class="form-group">
                     <label for="content">Description <span class="required text-danger">*</span></label>
...
<script type="text/javascript" src="<?php echo e(url('public/panel/custom/testimonial/index.js')); ?>"></script>
<?php $__env->stopSection(); ?>
<?php echo $__env->make('admin.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home1/digital5/public_html/elective/resources/views/admin/testimonial/index.blade.php ENDPATH**/ ?>