                            ...
                            <div class="row">  
                                 <div class="col-lg-4 col-md-6">
                                    <div class="form-group">
                                         ...
                                         <?php echo Form::select('srch_plan_type', ['' => 'Please Select'] + $plans, null, ['id' => 'srch_plan_type', 'class' => 'form-control']); ?>
...
<script type="text/javascript" src="<?php echo e(url('public/panel/custom/usertransaction/index.js')); ?>"></script>
<?php $__env->stopSection(); ?>
<?php echo $__env->make('admin.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home1/digital5/public_html/elective/resources/views/admin/usertransaction/index.blade.php ENDPATH**/ ?>