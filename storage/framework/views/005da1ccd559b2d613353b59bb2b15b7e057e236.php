          ...
          <div class="col-md-12">
            <div class="card">
              <div class="card-header">
                <h3 class="card-title float-left">Tours</h3>
         ...
         <form name="submitFrm" id="submitFrm">
            ...
            <div class="modal-body">
              ...
              <div class="col-lg-2">
               ...
               <div class="col-lg-12">
                  <div class="form-group">
                     <label for="itinerary_destination">Itinerary <span class="required text-danger">*</span></label>
               ...
               <div class="col-lg-12">
                  <div class="form-group">
                     <label for="what_included">What's Included <span class="required text-danger">*</span></label>
               ...
               <div class="col-lg-12">
                  <div class="form-group">
                     <label for="what_to_expect">What To Expect <span class="required text-danger">*</span></label>
               ...
               <div class="col-lg-12">
                  <div class="form-group">
                     <label for="additional_information">Additional Information <span class="required text-danger">*</span></label>
...
<script type="text/javascript" src="<?php echo e(url('public/panel/custom/tour/index.js')); ?>"></script>
<?php $__env->stopSection(); ?>
<?php echo $__env->make('admin.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home1/digital5/public_html/elective/resources/views/admin/tour/index.blade.php ENDPATH**/ ?>