         ...
         <div class="row mb-2">
            ...
            <div class="col-sm-6">
               <ol class="breadcrumb float-sm-right">
                  ...
                  <li class="breadcrumb-item"><a class="text-muted" href="<?php echo e(url('admin/addons')); ?>">Add-Ons & Events</a></li>
                  ...
                  <div class="card-body ribbon-box pb-1">
                     <div class="row">
                        <div class="col-md-2">
                           ...
                           <div style="border: 1px solid #DDD;padding: 3px;background-size: cover;"><img src="<?php echo e(url('public/uploads/addons/'.$data->image)); ?>" width="100%"></div>
                        </div>
                     </div>
                     <div class="row">
                        <div class="col-md-4">
                        ...
                        <div class="col-md-4">
                           <div class="form-group">
                              ...
                              <p><?php echo e($data->getprogram->title); ?></p>
                           </div>
                        </div>
                        <div class="col-md-4">
                           <div class="form-group">
                              <label class="control-label">Amount </label>
                              <p><?php echo e(ViewsHelper::displayAmount($data->payment_amount)); ?></p>
                           </div>
                        </div>
                        <div class="col-md-4">
                           <div class="form-group">
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('admin.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/digital5/public_html/elective/resources/views/admin/addon/view.blade.php ENDPATH**/ ?>