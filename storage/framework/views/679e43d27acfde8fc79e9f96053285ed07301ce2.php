          ...
          <div class="row">
            ...
            <div class="col-md-4">
              ...
              <div class="thumb">
                ...
                <img style="height: 270px;object-fit: cover;" src="<?php echo e(ViewsHelper::displayUserProfileImage($customer)); ?>" alt="">
            ...
            <div class="col-md-8">
              <div>
                ...
                <a href="<?php echo e(url('blogs-timeline/'.base64_encode($customer->customer_id))); ?>" class="btn btn-success pull-right">Blog Timeline</a>
              </div>
              <br>

              <h5 class="name mt-30 mb-0"><?php echo e($customer->full_name()); ?></h5>

              <h6 class="mt-5"><?php echo e($customer->occupation); ?></h6>

              <p><?php echo $customer->about_me; ?></p>
                  ...
                  <li>
                    ...
                    <div class="bg-light media border-bottom p-15 mb-20">
                      ...
                      <div class="media-body">
                        ...
                        <p><?php echo e($customer->displayAddress()); ?></p>
                  ...
                  <li>
                    ...
                    <div class="bg-light media border-bottom p-15">
                      ...
                      <div class="media-body">
                        ...
                        <p><span>Phone:</span> <?php echo e($customer->displayPhoneNumber()); ?><br><span>Email:</span> <?php echo e($customer->email); ?></p>
                ...
                <div class="row">
                  ...
                  <div class="col-sm-12">
                    ...
                    <div class="form-group">
                      ...
                      <input type="text" placeholder="Enter Name" id="contact_name" name="contact_name" value="<?php echo e(Auth::guard('customer')->user()->full_name()); ?>" readonly="" class="form-control">
                  ...
                  <div class="entry-header">
                    ...
                    <div class="post-thumb thumb"> 
                      ...
                      <?php if($row->upload_file == 'Video'): ?>
                        ...
                        <img src="<?php echo e(url('public/common/no-image.png')); ?>" alt="" class="img-responsive img-fullwidth" style="height: 209px;"> 
...
<script>
    ...
    $("#jssocialshare").jsSocials({
        ...
        url: "<?php echo e($customer->getDetailsPageUrl()); ?>",

        text: "<?php echo e($customer->full_name()); ?>",
...
<script type="text/javascript">
  ...
  var customer_id = "<?php echo e(base64_encode($customer->customer_id)); ?>";
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('frontend.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/digital5/public_html/elective/resources/views/frontend/pages/volunteer-details.blade.php ENDPATH**/ ?>