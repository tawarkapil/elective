...
<title>Guide - <?php echo e(ViewsHelper::getConfigKeyData('website_title')); ?></title>
         ...
         <div class="col-md-12">
            <div class="border-1px p-30 mb-0 bg-white">
               <div class="section-container">
                  <h4 class="text-theme-colored-blue"> Welcome <?php echo e(Auth::guard('customer')->user()->full_name()); ?>! </h4>
          ...
          <div class="col-md-12">
              <br>
              <a href="<?php echo e(url('profile')); ?>" class="btn btn-border btn-theme-colored pull-right">Next : Profile <i class="fa fa-arrow-circle-right"></i></a>
          </div>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('frontend.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home1/digital5/public_html/elective/resources/views/frontend/dashboard/guide.blade.php ENDPATH**/ ?>