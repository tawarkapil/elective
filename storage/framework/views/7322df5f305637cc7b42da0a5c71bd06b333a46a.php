           ...
           <div class="row">
               ...
               <div class="col-lg-12">
                  <div class="form-group">
                     ...
                     <?php echo Form::select('programs[]', $programs, null, ['id' => 'programs', 'class' => 'form-control select2', 'multiple' => true]); ?>
               ...
               <div class="col-lg-6">
                  <div class="form-group">
                     ...
                     <?php echo Form::select('country', [ '' => 'Please Select'] + $countries, null, ['id' => 'country', 'class' => 'form-control']); ?>
...
<script type="text/javascript" src="<?php echo e(url('public/panel/custom/destination/index.js')); ?>"></script>
<?php $__env->stopSection(); ?>
<?php echo $__env->make('admin.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home1/digital5/public_html/elective/resources/views/admin/destination/index.blade.php ENDPATH**/ ?>