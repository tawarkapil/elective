            ...
            <div class="border-1px p-30 mb-0 bg-white pt-10">
              <div class="section-container section-box1">
                ...
                <div class="col-lg-12"> 
                    ...
                    <h4 class="pagesub_title">Amount to be Paid: <?php echo e(ViewsHelper::displayAmount($data->payable_amount)); ?></h4>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('frontend.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home1/digital5/public_html/elective/resources/views/frontend/profile/deposit-payment.blade.php ENDPATH**/ ?>