   ...
   <div class="content-header">
      <div class="container-fluid">
         <div class="row mb-2">
            <div class="col-sm-6">
               <h1 class="m-0">
                  <?php if($page == 'visa-flights'): ?>
                  Visa & Flights
                  <?php elseif($page == 'insurance'): ?>
                  Insurance
                  <?php elseif($page == 'health-safety'): ?>
                  Health & Safety
                  <?php elseif($page == 'packing-list'): ?>
                  Packing List
                  <?php endif; ?>
               </h1>
            </div>
...
<?php echo $__env->make('frontend.layouts.dashboard_app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\xampp82\htdocs\elective\resources\views/frontend/static-pages/preDepature.blade.php ENDPATH**/ ?>